...
DSA_audio = de2bi(uint8('Pr??ctica 2 FASE II: 717781 y 714901'),8,'left-msb');%DSA size obtention
...
s_imagen = zeros(1, numel(s1)*mp); %zero's vector of s1*mp
s_imagen(1:mp:end) = s1; %Impulse train
pulse_train_imagen = conv(pnrz, s_imagen); %convolution of pnrz and s
