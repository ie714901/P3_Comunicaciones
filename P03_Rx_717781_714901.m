...
DSA_bits = bits_Rx(preamble_size+SFD_size+1:preamble_size+SFD_size+168);
...
DSA_bits_audio = bits_Rx(final_img+preamble_size+SFD_size+1:final_img+preamble_size+SFD_size+160);
